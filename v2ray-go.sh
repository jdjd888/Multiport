...
EOF
cat <<EOF >/etc/rare/v2ray/conf/05_VMess_NONE_WS_inbounds.json
{
  "inbounds": [
    {
      "listen": "127.0.0.1",
...
cd /usr/bin
wget -O v2ray-menu "https://raw.githubusercontent.com/SandakanVPNTrickster/Multiport/main/v2ray-menu.sh"
chmod +x v2ray-menu
cd
systemctl daemon-reload
